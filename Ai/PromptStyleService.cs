...
namespace OutfitReactions.Ai
{
    ...
    internal sealed class PromptStyleService
    {
        ...
        public static readonly string FallbackPlayerUnknownAddressRule =
            "PLAYER ADDRESS RULE: the player character's name is unavailable. Avoid overusing generic role labels as direct address; use natural dialogue without a vocative when possible.";
